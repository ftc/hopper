...
APP_NAME="Test"
PACKAGE_NAME="edu.colorado.plv.unittest"
ANDROID_VERSION="27"
BUILD_TOOL_VERSION="27.0.3"

AAPT="${ANDROID_HOME}/build-tools/${BUILD_TOOL_VERSION}/aapt"
DX="${ANDROID_HOME}/build-tools/${BUILD_TOOL_VERSION}/dx"
ZIPALIGN="${ANDROID_HOME}/build-tools/${BUILD_TOOL_VERSION}/zipalign"
